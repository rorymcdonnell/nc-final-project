...
const Marker = ({ location, groupData }) => {
  ...
  const setHTML = () => {
    ...
    let html = `<a href='https://rorymcdonnell.github.io/nc-final-project/${groupName}'><button class="a-enter-vr-button">Exit</button></a><a-scene
    embedded
    arjs="sourceType: webcam; videoTexture: true;;"><a-camera gps-camera='minDistance: 1' arjs-look-controls='smoothingFactor: 0.1 rotation-reader></a-camera><div id='members'>`;
